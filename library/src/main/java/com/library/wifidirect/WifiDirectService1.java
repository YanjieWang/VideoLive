...
public class WifiDirectService1 extends WifiDirectSuper1  implements ReceiveSocket.ProgressReceiveListener{
    private static final String TAG = "WifiDirectService1";
    private ProgressDialog mProgressDialog;

    public void init(Context context) {
        super.init(context);
        removeGroupAfterCreateGroup();
    }
     ...
     * 移除组群
     */
    public void removeGroupAfterCreateGroup() {
        mWifiP2pManager.removeGroup(mChannel, new WifiP2pManager.ActionListener() {
            @Override
            public void onSuccess() {
                Log.e(TAG, "移除组群成功");
